...
cd ../../../../../GONTI/GONTI-ENGINE/GONTI.RUNTIME/Source
set cFilenames=
...
if not exist "Include/GONTI/GONTI-ENGINE/GONTI.RUNTIME" (
    mkdir "Include/GONTI/GONTI-ENGINE/GONTI.RUNTIME"
)
...
rem Kompilacja
set assembly=GONTI.RUNTIME
set compilerFlags=-g -shared -Wvarargs -Wall -Werror
set includeFlags=-I"%workspaceFoldersInclude%" -I"%vcpkgIncludeDir%"
set linkerFlags=-L"%vcpkgLibDir%" -L"%GONTI-CORE-Libs-Dir%" -L"%GONTI-RENDER-Libs-Dir%" -luser32 -lGONTI.RENDER -lGONTI.CORE -lvulkan-1
...
echo(
echo =============================================================================
echo ===     START OF: make_GONTI.RUNTIME.bat Errors/Warnings/Informations     ===
echo =============================================================================
echo(
echo(
echo(
...
echo(
echo ===========================================================================
echo ===     END OF: make_GONTI.RUNTIME.bat Errors/Warnings/Informations     ===
echo ===========================================================================
echo(
echo(
echo(