...
set workspaceFoldersLib=D:\Projects\Visual Studio Code Projects\C++\GONTI SDK\_Build

rem ====== [!SETUP] ======

rem Zbieranie plików .c (Z Utilities\Build do PhysicsEngineSource)
cd ../../../../../GONTI/GONTI-ENGINE/GONTI.CORE/Source
set cFilenames=
...
if not exist "Include/GONTI/GONTI-ENGINE/GONTI.CORE" (
    mkdir "Include/GONTI/GONTI-ENGINE/GONTI.CORE"
)
...
rem Kompilacja
set assembly=GONTI.CORE
set compilerFlags=-g -shared -Wvarargs -Wall -Werror
set includeFlags=-I"%vcpkgIncludeDir%" -I"%workspaceFoldersInclude%"
set linkerFlags=-L"%vcpkgLibDir%" -L"%workspaceFoldersLib%" -luser32 -lvulkan-1 
...
echo(
echo ==========================================================================
echo ===     START OF: make_GONTI.CORE.bat Errors/Warnings/Informations     ===
echo ==========================================================================
echo(
echo(
echo(
...
echo(
echo ========================================================================
echo ===     END OF: make_GONTI.CORE.bat Errors/Warnings/Informations     ===
echo ========================================================================
echo(
echo(
echo(