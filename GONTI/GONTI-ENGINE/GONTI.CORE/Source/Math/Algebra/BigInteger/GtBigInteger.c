#include <Math/Algebra/BigInteger/GtBigInteger.h>
...
#include <Math/Algorithms/Arithmetic/Karatsuba/GtKaratsuba.h>
...
GtBigint gontiBigintNegOne(void) {
