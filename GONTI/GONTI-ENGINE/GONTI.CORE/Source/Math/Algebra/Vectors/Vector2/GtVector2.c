#include <Math/Algebra/Vectors/Vector2/GtVector2.h>
...
GtVec2 gontiVec2Zero(void) {
    return (GtVec2){.elements = {0.0f, 0.0f}};
}
GtVec2 gontiVec2One(void) {
    return (GtVec2){.elements = {1.0f, 1.0f}};
}
GtVec2 gontiVec2Up(void) {
    return (GtVec2){.elements = {0.0f, 1.0f}};
}
GtVec2 gontiVec2Down(void) {
    return (GtVec2){.elements = {0.0f, -1.0f}};
}
GtVec2 gontiVec2Left(void) {
    return (GtVec2){.elements = {-1.0f, 0.0f}};
}
GtVec2 gontiVec2Right(void) {
    return (GtVec2){.elements = {1.0f, 0.0f}};
}
