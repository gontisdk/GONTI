...
#if GONTI_USE_VULKAN && KPLATFORM_LINUX
...
b8 LinuxProc(GontiVulkanInternalStateLinux* state) {
    ...
    switch (event->response_type & ~0x80) {
        ...
        case XCB_KEY_RELEASE: {
            ...
            GontiInputKeyboardKeys key = translateKeycode(keySym);
        ...
        case XCB_BUTTON_RELEASE: {
            ...
            GontiInputMouseButtons mButton = BUTTON_MAX_BUTTONS;
        ...
        case XCB_CLIENT_MESSAGE: {
            ...
            if (cm->data.data32[0] == state->wmDeleteWin) return true;
        }break;
        default: break;
    }
...
GontiInputKeyboardKeys translateKeycode(u32 xKeyCode) {
    switch (x_keycode) {
        case XK_BackSpace:
