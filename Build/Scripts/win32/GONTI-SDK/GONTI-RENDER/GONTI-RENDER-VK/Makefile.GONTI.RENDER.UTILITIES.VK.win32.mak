...
ASSEMBLY := GONTI.RENDER.UTILITIES.VK
EXTENSION := .dll
COMPILER_FLAGS := -g -Wvarargs -Wall -Werror
INCLUDE_FLAGS := -I"$(VULKAN_SDK)/include" -IGONTI-SDK/ -I"$(SRC)/$(ASSEMBLY)/Source" -I$(GONTI_CORE_I)/GONTI.CORE/Source
LINKER_FLAGS := -g -shared -luser32 -lvulkan-1 -L"$(VULKAN_SDK)/lib" -L$(GONTI_CORE_L) -lGONTI.CORE
