BUILD := Build/bin/win32/GONTI-SDK/GONTI-RENDER
...
LINKER_FLAGS := -g -shared -luser32 -lvulkan-1 -L"$(VULKAN_SDK)/lib" -L$(GONTI_CORE_L) -lGONTI.CORE -lGONTI.MATH -L$(GONTI_RENDER_VK_L) -lGONTI.RENDER.CORE.VK -lGONTI.RENDER.VK -lGONTI.RENDER.SHADERS.VK
