...
INCLUDE_FLAGS := -I"$(VULKAN_SDK)/include" -IGONTI/ -I"$(SRC)/$(ASSEMBLY)/Source" -I"$(SRC)/GONTI.CORE/Source"
LINKER_FLAGS := -g -shared -lxcb -L"$(VULKAN_SDK)/lib" -lvulkan -L$(BUILD) -l:GONTI.CORE.so -Wl,-rpath,'$$ORIGIN'
