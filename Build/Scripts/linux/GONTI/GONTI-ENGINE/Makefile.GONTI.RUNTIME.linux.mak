...
INCLUDE_FLAGS := -I"$(VULKAN_SDK)/include" -IGONTI/ -I"$(SRC)/$(ASSEMBLY)/Source" -I"$(SRC)/GONTI.CORE/Source" -I"$(SRC)/GONTI.RENDER.VK/Source" -I"$(SRC)/GONTI.RENDER/Source"
LINKER_FLAGS := -g -shared -lX11 -lxcb -L"$(VULKAN_SDK)/lib" -lvulkan -L$(BUILD) -l:GONTI.CORE.so -l:GONTI.RENDER.VK.so -l:GONTI.RENDER.so -Wl,-rpath,'$$ORIGIN'
