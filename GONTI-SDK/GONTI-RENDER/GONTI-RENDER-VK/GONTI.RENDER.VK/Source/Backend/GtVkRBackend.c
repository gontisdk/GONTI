...
#include <Backend/GtVkRBackend.h>
...
#include <GONTI-CORE/GONTI.MATH/Source/Geometry/Vertices/GtVertexTypes.inl>
...
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.DEBUGGER.VK/Source/GtVkDebugger.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Hardware/Device/GtVkDevice.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/Swapchain/GtVkSwapchain.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/Renderpass/GtVkRenderpass.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/CommandBuffer/GtVkCmdBuffer.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/FrameBuffer/GtVkFrameBuffer.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/Sync/SyncObjects/GtVkSyncObjects.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.CORE.VK/Source/Subsystems/Sync/Fence/GtVkFence.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.UTILITIES.VK/Source/GtVkUtil.h>
#include <GONTI-RENDER/GONTI-RENDER-VK/GONTI.RENDER.SHADERS.VK/Source/ObjectShader/GtVkObjectShader.h>
...
GtB8 gontiVkRenderBackendRecreateSwapchain(GtVkContext* context) {
    if (context->swapchain.recreatingSwapchain) {
        GTDEBUG("gontiVkRecreategontiVkRenderBackendRecreateSwapchain called when already recreating. Booting...");
        return GtFalse;
    } 

    if (context->framebufferWidth == 0 || context->framebufferHeight == 0) {
        GTDEBUG("gontiVkRenderBackendRecreateSwapchain called when window < 1 in a dimension. Booting...");
        return GtFalse;
    }
...
GtB8 gontiVkRenderBackendInitialize(const char* appName, GtVkPlatformState* platState) {
...
GtB8 gontiVkRenderBackendBeginFrame(GtF32 deltaTime) {
    ...
    if (context.framebufferSizeGeneration != context.framebufferSizeLastGeneration) {
        ...
        if (!gontiVkRenderBackendRecreateSwapchain(&context)) {
...
GtB8 gontiVkRenderBackendEndFrame(GtF32 deltaTime) {
    if (context.imageIndex >= context.swapchain.imageCount) {
...
void gontiVkRenderBackendShutdown(void) {
    vkDeviceWaitIdle(context.device.logicalDevice);
    ...
    GTINFO("All render elements destroyed successfully.");
}
void gontiVkRenderBackendOnResized(GtU16 width, GtU16 height) {
...
void gontiVkRenderBackendUpdateGlobalStage(GtMat4 projection, GtMat4 view, GtVec3 viewPosition, GtVec4 ambientColour, GtI32 mode) {
    GtVkCmdBuffer* cmdBuffer = &context.graphicsCommandBuffers[context.imageIndex];
    ...
    gontiVkObjectShaderUpdateGlobalStage(&context, &context.objectShader);
