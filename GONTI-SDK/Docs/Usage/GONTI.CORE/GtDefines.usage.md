...
> **Internal mechanics:** [`GtDefines.how-it-works.md`](../../How-It-Works/GONTI.CORE/GtDefines.how-it-works.md)

---

## 1. Purpose

`GtDefines.h` provides the **engine-wide type system, platform detection, compiler abstractions, and utility macros**. It must be the first engine header included in every translation unit that uses `GONTI.CORE`.
