...
#define GtVector2H
    ...
    extern "C" {
        ...
        GTAPI GtVec2 gontiVec2Zero(void);
        GTAPI GtVec2 gontiVec2One(void);
        GTAPI GtVec2 gontiVec2Up(void);
        GTAPI GtVec2 gontiVec2Down(void);
        GTAPI GtVec2 gontiVec2Left(void);
        GTAPI GtVec2 gontiVec2Right(void);
