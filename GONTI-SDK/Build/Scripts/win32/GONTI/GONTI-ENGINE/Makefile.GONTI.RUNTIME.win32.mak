...
LINKER_FLAGS := -g -shared -luser32 -lvulkan-1 -lGONTI.CORE -lGONTI.RENDER.VK -lGONTI.RENDER -L"$(VULKAN_SDK)/lib" -L$(BUILD)/GONTI.CORE -L$(BUILD)/GONTI.RENDER.VK -L$(BUILD)/GONTI.RENDER
